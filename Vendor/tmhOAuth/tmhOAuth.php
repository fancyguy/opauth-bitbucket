...
class tmhOAuth {
  ...
  function set_user_agent() {
    ...
    $ua = 'tmhOAuth ' . self::VERSION . $ssl . ' - //github.com/fancyguy/opauth-bitbucket';
  ...
  private function sign($method, $url, $params, $useauth) {
	...
	$signeture = $this->safe_encode(base64_encode( hash_hmac('sha1', $this->base_string, $this->signing_key, true)));
